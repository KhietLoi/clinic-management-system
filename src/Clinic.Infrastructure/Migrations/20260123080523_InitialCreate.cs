        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<byte>(type: "tinyint", nullable: false, defaultValue: (byte)0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicRooms", x => x.ClinicRoomId);
                    table.ForeignKey(
                        name: "FK_ClinicRooms_Specialties_SpecialtyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Symptomps = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: true),
                    Diagnosis = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: true),
